...
class lvl1{
    constructor(){
        ...
        this.portal = createSprite(4180, 325, 20, 20)
        ...
        this.rightBarrier = createSprite(4210, this.h / 2, 20, this.h)
        this.rightBarrier.visible = false
    ...
    play(){
        ...
        this.player.plr.collide(this.rightBarrier)
    ...
    image(this.bgp1, 0, 0, 4240, this.h)
        ...
        if(this.storylineBool){
            ...
            if(this.storylinePart == 0){
                ...
                this.storyline.addImage(this.storyp2)
                this.storyline.x = this.w / 1.4
                this.storyline.y = this.h / 1.4
            }else if(this.storylinePart == 2){
                this.storyline.addImage(this.storyp3)
                this.storyline.y = this.h / 1.5
                this.storyline.x = this.w / 3.5
            ...
            // moving camera
            if(this.player.plr.x > displayWidth * 2.236){
                this.cameraPlus = 0
            }else if(this.player.plr.x > camera.position.x - 10){
                this.cameraPlus = 10
